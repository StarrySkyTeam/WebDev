...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1458908247, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/wxd_mobile', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1458908247, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/wxd_mobile', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1458908247, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/wxd_mobile', 'common/header_forum_index')
;?>
